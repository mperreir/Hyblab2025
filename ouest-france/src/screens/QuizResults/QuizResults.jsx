        ...
        >
            <div className="flex justify-center items-center flex-col gap-8 h-full w-full mr-[50%]">
                {choosenPlayer === "player1" && (
                    <div className="choice right z-10">
                ...
                {choosenPlayer === "player2" && (
                    <div className="choice right pavon z-10">
                        <div className="img-container">
                ...
                <div className={'w-full h-screen flex flex-col gap-8 justify-center items-center endquiz-left'}>
                    <ReactStars
                        count={quizLength}
